/*
    * TRIGGER (트리거) *
    ...
    - 종류 -
      [1] 실행 시기에 따른 분류
          * BEFORE TRIGGER  : 테이블의 데이터가 바뀌기 "전"에 트리거 실행 (데이터 검증용)
          * AFTER TRIGGER   : 테이블의 데이터가 바뀐 "후"에 트리거 실행 (대부분 비즈니스 로직 처리용)
...
/*
    * 트리거 생성 *
    ...
    /
*/
-- * EMPLOYEE 테이블에 데이터가 추가된 후에 작동하는 행 트리거 생성 * (TRG_WELCOME)
...
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
            VALUES (SEQ_ENO.NEXTVAL, '임수진', '060714-4000000', 'J4', SYSDATE);

INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
            VALUES (SEQ_ENO.NEXTVAL, '정수진', '040714-4000000', 'J4', SYSDATE);
