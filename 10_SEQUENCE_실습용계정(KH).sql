...
--> 오류 발생!! 최댓값(310)을 초과할 수 없음!! (NOCYCLE 옵션으로 생성했기 때문에)
--------------------------------------------------------------------------------
/*
    * 시퀀스 변경 *
...
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
                VALUES (SEQ_ENO.NEXTVAL, '임수진', '060713-4000000', 'J6', SYSDATE);
                --> 300번 직원번호가 저장됨
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
                VALUES (SEQ_ENO.NEXTVAL, '박수진', '050713-4000000', 'J6', SYSDATE);
                --> 301번 직원번호로 저장됨
...
INSERT INTO EMPLOYEE (EMP_ID, EMP_NAME, EMP_NO, JOB_CODE, HIRE_DATE)
                VALUES (SEQ_ENO.NEXTVAL, '조수진', '040713-4000000', 'J6', SYSDATE);
