...
/*
    * TCL (TRANSCATION CONTROL LANGUAGE, 트랜잭션 제어어)
    ...
    - 트랜잭션 : 데이터베이스의 논리적 연산 단위
                ...
                -> 트랜잭션에 추가되는 SQL(DML) : INSERT / UPDATE / DELETE / MERGE???
...
--> DDL(CREATE, ALTER, DROP)을 사용하게 되면 기존 트랜잭션에 저장된 변경사항들은 무조건 반영됨 (COMMIT)
